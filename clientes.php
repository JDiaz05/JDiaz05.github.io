...
<header>
      <div class="contenedor">
        <h1><i class="fa-solid fa-user-group"></i>  Clientes</h1>
  ...
  <div class="col-md-3">
     ...
     <h3>Nuevo cliente</h3>
       ...
       <?php
         ...
         include 'clientes_registrar.php';
         include 'clientes_eliminar.php';

       ?>

     <form action="clientes_registrar.php" method="post">
      ...
      <input type="text" class="form-control mb-3" name="comentarios" placeholder="Nota/comentario  (max 50 caracteres)" maxlength="50">
     ...
     <thead class="table-warning table-striped">
        ...
        <tbody>
          <?php
            ...
            while($clientes=$sql->fetch_object()){ ?>
          <tr>
            <td><?=$clientes->id_c?></td>
            ...
            <td>
              <a href="clientes_modificar.php?id=<?= $clientes->id_c?>" class="btn btn-small btn-primary"><i class="fa-solid fa-pen-to-square"></i></a>
            </td>
            <td>
              <a onclick="return eliminar()" href="clientes.php?id=<?= $clientes->id_c?>" class="btn btn-small btn-danger"><i class="fa-solid fa-trash"></i></a>
            </td>
          </tr>
